...
class DatabaseRepository @Inject constructor(
    ...
    override fun getRoster(): Flow<List<MKPlayer>> = newPlayerLocalDataSource.getAll().flowOn(Dispatchers.IO)
    override fun getWars(): Flow<List<MKWar>> = warDataSource.getAll().flowOn(Dispatchers.IO)
    override fun writeRoster(list: List<MKPlayer>): Flow<Unit> = newPlayerLocalDataSource.bulkInsert(list).flowOn(Dispatchers.IO)
