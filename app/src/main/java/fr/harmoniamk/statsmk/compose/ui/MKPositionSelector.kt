...
@Composable
fun MKPositionSelector(position: Int, modifier: Modifier = Modifier) {
    Card(backgroundColor = colorResource(id = R.color.white_alphaed), modifier = modifier.padding(5.dp)) {
...
fun MKPositionPreview() {
    Column() {
        Row() {
            ...
            MKPositionSelector(position = 2, modifier = Modifier.weight(1f))
