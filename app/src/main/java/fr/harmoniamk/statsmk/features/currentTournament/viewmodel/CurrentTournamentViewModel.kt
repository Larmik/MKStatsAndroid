package fr.harmoniamk.statsmk.features.currentTournament.viewmodel
...
class CurrentTournamentViewModel @Inject constructor(
    ...
    private val _sharedEditTrack = MutableSharedFlow<PlayedTrack>()
    ...
    private val _sharedTracks = MutableSharedFlow<List<PlayedTrack>>()
    ...
    fun bind(tmId: Int, onAddTrackClick: Flow<Unit>, onCancel: Flow<Unit>, onTrackEdit: Flow<PlayedTrack>) {
        var points = 0
