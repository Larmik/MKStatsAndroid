...
sealed class MenuItems(val titleRes: Int, val route: String? = null, val type: ListItemType) {
   class ManagePlayers() : MenuItems(R.string.mon_quipe, "Home/Settings/Team", ListItemType.settings)
   class ManageTeams() : MenuItems(R.string.g_rer_les_quipes, "Home/Settings/Opponents", ListItemType.settings)
   class Players() : MenuItems(R.string.joueurs_libres, "Home/Settings/Players", ListItemType.settings)
   class Profile() : MenuItems(R.string.profil, "Home/Settings/Profile", ListItemType.settings)
   ...
   class MapStats() : MenuItems(R.string.statistiques_des_circuits, "Home/Stats/Maps", ListItemType.stats)
   class PeriodicStats() : MenuItems(R.string.statistiques_p_riodiques, "Home/Stats/Periodic", ListItemType.stats)
   class ChangePseudo() : MenuItems(R.string.changer_mon_pseudo, null, ListItemType.profile)
   ...
   class LeaveTeam() : MenuItems(R.string.quitter_mon_quipe, null, ListItemType.profile)
